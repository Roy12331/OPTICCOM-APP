import 'dart:convert';
import 'dart:io';
import 'package:flutter/foundation.dart' show kIsWeb; // 🔹 Solución para la Web
import 'package:flutter/material.dart';
import 'package:go_router/go_router.dart';
import 'package:image_picker/image_picker.dart';
import 'package:geolocator/geolocator.dart';
import 'package:permission_handler/permission_handler.dart';
import 'package:signature/signature.dart'; // 🔹 Nueva librería de firmas
...
class _FormularioScreenState extends State<FormularioScreen> {
  ...
  // Control de Pasos (1 = Datos Técnicos, 2 = Evidencia y Firma)
  int _pasoActual = 1;
  ...
  // Puerto NAP (Estilo cuadritos de Figma)
  int _puertoSeleccionado = 1;

  // Variables de Evidencias (Usamos XFile para que no explote en la Web)
  XFile? _fotoFachada;
  XFile? _fotoEquipo;

  // Controlador de la Firma
  ...
  // ==========================================================
  // LÓGICA DE FOTOS Y GPS (Compatible Web y Móvil)
  // ==========================================================
  ...
  // Convierte el XFile a Base64 sin usar dart:io (Para que funcione en Web)
  ...
  void _finalizarOrden() async {
    ...
    final datos = {
      ...
      "lat": _gpsLat,
      "lon": _gpsLon,
      "foto_base64": base64Fachada ?? "", // Mandamos la fachada por ahora
    ...
    if (esInstalacion) {
      ...
      datos["puerto"] =
          _puertoSeleccionado; // Mandamos el cuadrito seleccionado
    } else {
      ...
      child: Column(
        ...
        children: [
          if (esInstalacion) ...[
            ...
            _label("Puerto NAP"),
            _selectorPuertos(), // 🔹 Selector de cuadritos Figma
            const SizedBox(height: 20),
          ] else ...[
                ...
                child: ElevatedButton(
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      setState(() => _pasoActual = 2); // Pasar a Evidencias
                    }
                  },
  ...
  // ==========================================================
  // WIDGETS AUXILIARES PARA EL DISEÑO FIGMA
  // ==========================================================
  ...
  // Los cuadritos del Puerto NAP (1 al 6)
  ...
  // Caja para subir foto (Soporta Web y Móvil)
